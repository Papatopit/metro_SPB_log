...
public class Main
{
    ...
    private static final Marker INPUT_INFO = MarkerManager.getMarker("INPUT_INFO");
    private static final Marker WRONG_STATION = MarkerManager.getMarker("WRONG_STATION");
    private static final Marker EXEPTION = MarkerManager.getMarker("EXEPTION");
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            for (; ; ) {
                ...
                logger.info(INPUT_INFO,"Cтанция отправления: "+ from.getName());
                Station to = takeStation("Введите станцию назначения:");
                logger.info(INPUT_INFO,"Станция назначения: "+ to.getName());
            ...
            logger.error(EXEPTION,exception.getMessage(),throwable);
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            try {
                ...
                logger.error(WRONG_STATION,"Станция не найдена :(" + line);
            }catch (Exception ex){
                ex.printStackTrace();
                logger.error(ex);
            }
